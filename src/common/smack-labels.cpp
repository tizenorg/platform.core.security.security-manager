        ...
        const std::string &zoneId)
{
    ...
    case SECURITY_MANAGER_PATH_RW:
        label = generateLabelForZone(generateAppLabel(appId), zoneId);
        ...
        const std::string& zoneId)
{
    ...
    pathSetSmack(pkgPath.c_str(), generateLabelForZone(generatePkgLabel(pkgId), zoneId), XATTR_NAME_SMACK);
    pathSetSmack(appPath.c_str(), generateLabelForZone(generateAppLabel(appId), zoneId), XATTR_NAME_SMACK);
