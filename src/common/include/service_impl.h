...
public:
    ...
    * @param[in] authorized indicates that request is already authorized
    *            and Cynara shouldn't be checked, to be used during user removal
    *
    * @return API return code, as defined in protocols.h
    */
    int appUninstall(const Credentials &creds, app_inst_req &req, bool authorized = false);
