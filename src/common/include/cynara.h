...
private:
    ...
    // For sending messages to Cynara thread
    static const eventfd_t eventPollRestart = 0xB16B00B5;
    static const eventfd_t eventTerminate   = 0xDEADBEEF;
    void threadEventPut(eventfd_t event);
    eventfd_t threadEventGet();
