...
ln -s ../security-manager.service %{buildroot}/%{_unitdir}/sysinit.target.wants/security-manager.service
...
%attr(755,root,root) %{_unitdir}/sysinit.target.wants/security-manager.service
