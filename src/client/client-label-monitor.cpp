...
int security_manager_app_labels_monitor_init(app_labels_monitor **monitor)
{
    return try_catch([&] {
        ...
        *monitor = nullptr;
        ...
        auto monitorPtr = make_unique(new app_labels_monitor, security_manager_app_labels_monitor_finish);
        if (!monitorPtr) {
...
void security_manager_app_labels_monitor_finish(app_labels_monitor *monitor)
{
    try_catch([&] {
        ...
        auto monitorPtr = make_unique(monitor);
...
int security_manager_app_labels_monitor_process(app_labels_monitor *monitor)
{
    return try_catch([&] {
        ...
        auto bufPtr = make_unique<char[]>(avail);
