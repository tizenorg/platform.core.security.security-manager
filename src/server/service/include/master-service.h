...
private:
     ...
     * @param  zoneId ID of zone from which the connection came
     */
    void processPolicyUpdate(MessageBuffer &buffer, MessageBuffer &send, const std::string &zoneId);
    ...
    void processGetPolicy(MessageBuffer &buffer, MessageBuffer &send, const std::string &zoneId);
