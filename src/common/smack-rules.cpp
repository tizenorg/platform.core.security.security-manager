...
#define REPLACE_PREFIX(STR, PREFIX, REPLACE) {      \
    ...
    for (auto rule : templateRules) {
        ...
        REPLACE_PREFIX(subject, SMACK_PKG_LABEL_TEMPLATE, SmackLabels::generateAppLabel(pkgId));
        REPLACE_PREFIX(object,  SMACK_APP_LABEL_TEMPLATE, SmackLabels::generateAppLabel(appId));
        REPLACE_PREFIX(object,  SMACK_PKG_LABEL_TEMPLATE, SmackLabels::generateAppLabel(pkgId));
