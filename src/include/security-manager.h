...
#define SECURITY_MANAGER_API_ERROR_NO_SUCH_COOKIE -13

/*! \brief   indicating there is no phone password set  */
#define SECURITY_MANAGER_API_ERROR_NO_PASSWORD -14

/*! \brief   indicating password exists in system  */
#define SECURITY_MANAGER_API_ERROR_PASSWORD_EXIST -15

/*! \brief   indicating password mismatch  */
#define SECURITY_MANAGER_API_ERROR_PASSWORD_MISMATCH -16

/*! \brief   indicating password retry timeout is not occurred yet  */
#define SECURITY_MANAGER_API_ERROR_PASSWORD_RETRY_TIMER -17

/*! \brief   indicating password retry timeout is not occurred yet  */
#define SECURITY_MANAGER_API_ERROR_PASSWORD_MAX_ATTEMPTS_EXCEEDED -18

/*! \brief   indicating password retry timeout is not occurred yet  */
#define SECURITY_MANAGER_API_ERROR_PASSWORD_EXPIRED -19

/*! \brief   indicating password retry timeout is not occurred yet  */
#define SECURITY_MANAGER_API_ERROR_PASSWORD_REUSED -20
