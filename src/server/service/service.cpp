        ...
        Try {
            ...
            switch (call_type) {
                ...
                case SecurityModuleCall::GET_CONF_POLICY_ADMIN:
                    processGetConfiguredPolicy(buffer, send, uid, pid, smack_label, true);
                    break;
                case SecurityModuleCall::GET_CONF_POLICY_SELF:
                    processGetConfiguredPolicy(buffer, send, uid, pid, smack_label, false);
                    break;
                case SecurityModuleCall::GET_POLICY:
                    processGetPolicy(buffer, send, uid, pid, smack_label);
                    break;
                default:
