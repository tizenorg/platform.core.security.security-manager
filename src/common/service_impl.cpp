...
int userAdd(uid_t uidAdded, int userType, uid_t uid)
{
    ...
    case SM_USER_TYPE_SYSTEM:
        goToBucket = CynaraAdmin::getInstance().Buckets.at(Bucket::USER_TYPE_SYSTEM);
        break;
    case SM_USER_TYPE_ADMIN:
        goToBucket = CynaraAdmin::getInstance().Buckets.at(Bucket::USER_TYPE_ADMIN);
        break;
    case SM_USER_TYPE_GUEST:
        goToBucket = CynaraAdmin::getInstance().Buckets.at(Bucket::USER_TYPE_GUEST);
        break;
    case SM_USER_TYPE_NORMAL:
        goToBucket = CynaraAdmin::getInstance().Buckets.at(Bucket::USER_TYPE_NORMAL);
        break;
    default:
        return SECURITY_MANAGER_API_ERROR_INPUT_PARAM;
    }
    ...
    policies.push_back(CynaraAdminPolicy(CYNARA_ADMIN_WILDCARD,
                                        ...
                                        goToBucket,
                                        CynaraAdmin::getInstance().Buckets.at(Bucket::MAIN)));
