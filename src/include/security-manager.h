...
/**
 * This function returns mapping of ONE privilege from one version to the other.
 *
 * Caller needs to free memory allocated for the list using
 ...
 * @param[in] privilege Name of privilege to be mapped
 * @param[out] privilege_mapping Pointer to list of privileges which given privilege maps to
 * @param[put] mapping_count Number of mapped privileges
 * @return API return code or error code
 */
int security_manager_get_privilege_mapping(const char *from_version,
                                           const char *to_version,
                                           const char *privilege,
                                           char ***privilege_mapping,
 ...
 * @param[in] from_version Version of passed privilege
 * @param[in] to_version Version of requested mapping, if NULL default one will be used
 * @param[in] privileges Name of privilege to be mapped
 ...
 */
void security_manager_privilege_mapping_free(char **privilege_mapping, size_t mapping_count);
#ifdef __cplusplus
}
#endif
