...
PRIMARY KEY (app_id, uid, privilege_id),
FOREIGN KEY (app_id, uid) REFERENCES user_app (app_id, uid)
...
SELECT
	...
	user_app_pkg_view.uid as uid,
	user_app_pkg_view.app_id as app_id,
	user_app_pkg_view.app_name as app_name,
	user_app_pkg_view.pkg_id as pkg_id,
	user_app_pkg_view.pkg_name as pkg_name,
	privilege.name as privilege_name
FROM user_app_privilege
LEFT JOIN user_app_pkg_view USING(app_id, uid)
...
BEGIN
	...
	INSERT OR IGNORE INTO user_app_privilege(app_id, uid, privilege_id) VALUES
...
BEGIN
	DELETE FROM user_app_privilege WHERE app_id=OLD.app_id AND uid=OLD.uid AND privilege_id=OLD.privilege_id;
END;
