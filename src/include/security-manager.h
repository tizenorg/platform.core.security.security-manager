 ...
 * This api is intend to be used to decrease user's own level of privilege
 *
 * \param[in] p_entry Pointer handling policy_entry structure
 ...
 * This function is intend to be used by admin to change level of privilege.
 * If it is used by user that has no privilege http://tizen.org/privilege/systemsettings.admin
 * then security_manager_policy_update_send will return error code.
 *
 * \param[in] p_entry Pointer handling policy_entry structure
 * \param[in] policy_level Policy level to be set
 * \return API return code or error code
 ...
 *   (Deny access from app MyApp1 to privielge http://tizen.org/privilege/systemsettings,
 *   deny access from app MyApp2 to privielge http://tizen.org/privilege/systemsettings,
 *   deny access from app MyApp3 to privielge http://tizen.org/privilege/notificationmanager)
 *
 *      extern char *level_deny; //already contain string that represents denying level of policy
 ...
 *      security_manager_policy_entry_set_level(entry1, level_deny);
 *
 ...
 *      security_manager_policy_entry_set_level(entry2, level_deny);
 *
 ...
 *      security_manager_policy_entry_set_level(entry3, level_deny);
 *
 ...
 *
 *      extern char *level_deny; //already contain string that represents denying level of policy
 *      extern char *level_allow; //already contain string that represents allowing level of policy
 *      policy_update_req *policy_update_request;
 *
 *      security_manager_policy_update_req_new(&policy_update_request);
 ...
 *      security_manager_policy_entry_admin_set_level(entry1, level_deny);
 *
 ...
 *      security_manager_policy_entry_admin_set_level(entry2, level_allow);
 *
 *      security_manager_policy_update_req_add_entry(policy_update_request, entry1);
 *      security_manager_policy_update_req_add_entry(policy_update_request, entry2);
 *
