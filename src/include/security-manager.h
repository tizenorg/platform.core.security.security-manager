 ...
 *
 * \param[in] Address of pointer for handle private_sharing_req structure
 * \return API return code or error code
 */
...
/*
 * This function is used to set up path list to be shared in private_sharing_req structure
 *
 * \param[in] Pointer handling private_sharing_req structure
 * \param[in] Path list
 * \param[in] Path count
