 ...
 * Calling this function may be ommited if user wants to set policies for himself
 * \param[in] p_entry Pointer handling policy_entry structure
...
/**
 * This function is used to set up user privilege level in p_entry structure
 *
 * \param[in] p_entry Pointer handling policy_entry structure
 * \param[in] policy_level Policy level to be set
 * \return API return code or error code
 */
int security_manager_policy_entry_set_user_level(policy_entry *p_entry, const char *policy_level);

/**
 * This function is used to set up admin privilege level.
 *
...
int security_manager_policy_update_req_add_entry(policy_update_req)
/**
 ...
 * \return API return code or error code
 *
 * Example: (checking return codes omitted in examples...)
 *
