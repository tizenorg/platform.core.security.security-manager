...
int CynaraAdmin::Check(const std::string &appId, const std::string &user, const std::string &privilege,
    const Bucket bucket, int *result, char **result_extra)
{
