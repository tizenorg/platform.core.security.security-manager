...
public:
     ...
     *
     * @param[in] pkgId - installed package id to be given access
     * @param[in] pkgContents - list of all applications inside this package
     * @param[in] appsGranted - list of 2.x apps to grant access
     * @param[in] accessPackages - list of 2.x packages to be accessed
     * @param[in] zoneId - ID of zone which requested application install
     */
    void generateCross2XApplicationDeps(const std::string pkgId,
