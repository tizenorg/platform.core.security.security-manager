 ...
 *
 * \param[in] Address of pointer for handle path_req structure
 ...
 *  \param[in] Pointer handling allocated path_req structure
 */
 ...
 *
 * \param[in] Pointer handling path_req structure
 ...
 *
 * \param[in] Pointer handling path_req structure
 * \param[in] Package path
 * \param[in] Package path type
 * \return API return code or error code
 */
...
/*
 * This function is used to unregister a set of paths for given package using
 * filled up path_req data structure. Paths will be automatically unregistered
 * during uninstallation of last application from the package.
 *
 * \param[in] Pointer handling app_inst_req structure
 * \return API return code or error code
 */
int security_manager_paths_unregister(const path_req *p_req);
