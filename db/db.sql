...
BEGIN
    ...
    INSERT OR IGNORE INTO app(pkg_id, name, uid, Tizen_ver) VALUES ((SELECT pkg_id FROM pkg WHERE name=NEW.pkg_name), NEW.app_name, NEW.uid, NEW.Tizen_ver);
END;
