...
const char *const PKG_RULES_TEMPLATE_FILE_PATH = "/usr/share/security-manager/policy/pkg-rules-template.smack";
...
const char *const AUTHOR_RULES_TEMPLATE_FILE_PATH = "/usr/share/security-manager/policy/author-rules-template.smack";
