                                  ...
                                  InterfaceID interfaceID)
{
    ...
    if (!getPeerCreds(conn.sock, creds)) {
...
void Service::processAppInstall(MessageBuffer &buffer, MessageBuffer &send, credentials &creds)
{
    app_inst_req req;
    ...
    Serialization::Serialize(send, serviceImpl.appInstall(creds, req));
}

void Service::processAppUninstall(MessageBuffer &buffer, MessageBuffer &send, credentials &creds)
{
    app_inst_req req;

    req.uid = creds.uid;
    Deserialization::Deserialize(buffer, req.appName);
    Serialization::Serialize(send, serviceImpl.appUninstall(creds, req));
}
...
void Service::processGetAppGroups(MessageBuffer &buffer, MessageBuffer &send, credentials &creds)
{
    std::string appName;
...
void Service::processUserAdd(MessageBuffer &buffer, MessageBuffer &send, credentials &creds)
{
    int ret;
    uid_t uidAdded;
    int userType;
...
void Service::processUserDelete(MessageBuffer &buffer, MessageBuffer &send, credentials &creds)
{
    int ret;
    uid_t uidRemoved;
...
void Service::processPolicyUpdate(MessageBuffer &buffer, MessageBuffer &send, credentials &creds)
{
    int ret;
...
void Service::processGetConfiguredPolicy(MessageBuffer &buffer, MessageBuffer &send, credentials &creds, bool forAdmin)
{
    int ret;
    policy_entry filter;
...
void Service::processGetPolicy(MessageBuffer &buffer, MessageBuffer &send, credentials &creds)
{
    int ret;
    policy_entry filter;
    Deserialization::Deserialize(buffer, filter);
...
void Service::processApplyPrivateSharing(MessageBuffer &recv, MessageBuffer &send, credentials &creds)
{
...
void Service::processDropPrivateSharing(MessageBuffer &recv, MessageBuffer &send, credentials &creds)
{
    std::string ownerAppName, targetAppName;
    std::vector<std::string> paths;
    Deserialization::Deserialize(recv, ownerAppName);
