...
int userAdd(uid_t uidAdded, int userType, uid_t uid)
{
    ...
    case SM_USER_TYPE_SYSTEM:
        goToBucket = CynaraAdmin::getInstance().Buckets.at(BucketType::USER_TYPE_SYSTEM);
        break;
    case SM_USER_TYPE_ADMIN:
        goToBucket = CynaraAdmin::getInstance().Buckets.at(BucketType::USER_TYPE_ADMIN);
        break;
    case SM_USER_TYPE_GUEST:
        goToBucket = CynaraAdmin::getInstance().Buckets.at(BucketType::USER_TYPE_GUEST);
        break;
    case SM_USER_TYPE_NORMAL:
        goToBucket = CynaraAdmin::getInstance().Buckets.at(BucketType::USER_TYPE_NORMAL);
        break;
    default:
        return SECURITY_MANAGER_API_ERROR_INPUT_PARAM;
    }
    ...
    policies.push_back(CynaraAdminPolicy(CYNARA_ADMIN_WILDCARD,
                                        ...
                                        goToBucket,
                                        CynaraAdmin::getInstance().Buckets.at(BucketType::MAIN)));
...
int bucketsInit(uid_t uidInContext)
{
    ...
    CynaraAdmin::getInstance().InitBucket(BucketType::ADMIN);
    CynaraAdmin::getInstance().InitBucket(BucketType::MANIFESTS);
    CynaraAdmin::getInstance().InitBucket(BucketType::USER_TYPE_ADMIN);
    CynaraAdmin::getInstance().InitBucket(BucketType::USER_TYPE_NORMAL);
    CynaraAdmin::getInstance().InitBucket(BucketType::USER_TYPE_SYSTEM);
    CynaraAdmin::getInstance().InitBucket(BucketType::USER_TYPE_GUEST);
    CynaraAdmin::getInstance().InitBucket(BucketType::MAIN);
    CynaraAdmin::getInstance().InitBucket(BucketType::PRIVACY_MANAGER);
