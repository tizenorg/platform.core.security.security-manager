...
private:
     ...
     */
    void processAppInstall(MessageBuffer &buffer, MessageBuffer &send, credentials &creds);
     ...
     * @param  creds  credentials of the requesting process
     */
    void processAppUninstall(MessageBuffer &buffer, MessageBuffer &send, credentials &creds);
     ...
     * @param  creds  credentials of the requesting process
     */
    void processGetAppGroups(MessageBuffer &buffer, MessageBuffer &send, credentials &creds);

    void processUserAdd(MessageBuffer &buffer, MessageBuffer &send, credentials &creds);

    void processUserDelete(MessageBuffer &buffer, MessageBuffer &send, credentials &creds);
     ...
     * @param  creds  credentials of the requesting process
     */
    void processPolicyUpdate(MessageBuffer &buffer, MessageBuffer &send, credentials &creds);
     ...
     */
    void processGetConfiguredPolicy(MessageBuffer &buffer, MessageBuffer &send, credentials &creds, bool forAdmin);
     ...
     * @param  creds  credentials of the requesting process
     */
    void processGetPolicy(MessageBuffer &buffer, MessageBuffer &send, credentials &creds);
     ...
     * @param  send   Raw data buffer to be sent
     */
    void processApplyPrivateSharing(MessageBuffer &recv, MessageBuffer &send, credentials &creds);
    /**
     ...
     * @param  send   Raw data buffer to be sent
     */
    void processDropPrivateSharing(MessageBuffer &recv, MessageBuffer &send, credentials &creds);
};
